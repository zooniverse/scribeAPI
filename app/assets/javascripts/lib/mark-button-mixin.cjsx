  ...
  respondToMarkState: ->
    ...
    switch markStatus
      ...
      when 'transcribe-finished'
        ...
        location.replace "/#/transcribe/#{@props.subject_id}?scrollX=#{window.scrollX}&scrollY=#{window.scrollY}&page=#{@props.subjectsubjectCurrentPage}&mark_key=#{@props.taskKey}"
        @forceUpdate()
        # @setState locked: true
