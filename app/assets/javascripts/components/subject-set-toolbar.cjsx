  ...
  render: ->
    ...
    <div className="subject-set-toolbar">
      ...
      <div className="subject-set-toolbar-links">
        ...
        {if @props.subject_set?.subjects.length > 1
          <a className={"toggle-multi-page" + if @state.active_pane == 'multi-page' then ' active' else '' } onClick={() => @togglePane 'multi-page'}><div className="helper">Toggle multi-page navigation</div></a>
        }
      </div>
    </div>
