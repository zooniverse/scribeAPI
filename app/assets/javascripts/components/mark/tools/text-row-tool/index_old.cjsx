...
module.exports = React.createClass
  ...
  handleDrag: (e) ->
    ...
    markHeight = mark.yLower - mark.yUpper
    @props.mark.x = x + @props.clickOffset.x # add initial click offset
    @props.mark.y = y + @props.clickOffset.y
    @props.mark.yUpper = @props.mark.y - markHeight/2
    @props.mark.yLower = @props.mark.y + markHeight/2
